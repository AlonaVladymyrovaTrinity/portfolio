...
const ProjectsList = [
  {
    ...
    builtWith:
      'React, React Router, Redux, Axios, React Auth Context, HTML5, CSS3, React bootstrap, JavaScript, Petfinder.com API, Stripe, Node.js, Express, JWT, MongoDB, Swagger UI, Nodemailer, Jest',
  ...
  },
  {
    imgsrc: BeatBazaar,
    title: 'BeatBazaar',
    text: 'Team project BeatBazaar represents a collaborative effort—a Music e-commerce app where users can seamlessly stream, curate wishlists, and purchase their favorite songs.',
    builtWith:
  ...
  },
  {
    imgsrc: StarWars,
    title: 'Star Wars',
    text: 'Personal Project: Star Wars App - Streamline access to Star Wars API (https://swapi.dev/) data, displaying key categories such as characters, planets, films, species, vehicles, and starships.',
    builtWith: 'HTML5, CSS3, JavaScript, APIs',
